...
const Navbar = () => {
  return (
    <nav className='flex space-y-5 md:space-y-0 flex-col md:flex-row items-center md:justify-between sticky bottom-0  py-8 text-md md:text-lg  px-10 md:px-32 bg-black/20 z-30'>
